...
-- Drop only the property-related tables (this will cascade to property_images)
DROP TABLE IF EXISTS property_images CASCADE;
DROP TABLE IF EXISTS property_listings CASCADE;

-- Recreate property_listings table (clean version without timestamps and URLs)
...
-- Recreate property_images table (clean version without timestamps)
...
CREATE INDEX idx_property_listings_transaction_type ON property_listings(transaction_type);
CREATE INDEX idx_property_listings_bedrooms ON property_listings(bedrooms);
CREATE INDEX idx_property_images_property_id ON property_images(property_id);

-- Insert property listings data (BuyRentKenya scraped data - IDs 1-10)
-- Property 1: 4 Bedroom Townhouse in Spring Valley
INSERT INTO property_listings (id, title, price, location, bedrooms, bathrooms, area, property_type, transaction_type) VALUES
(1, '4 Bedroom Property', 'KSh 78,000,000', '4 Bed Townhouse with En Suite at Spring Valley - Shanzu Road ', 4, 4, 'N/A', 'Townhouse', 'Sale');

-- Property 2: 5 Bedroom House in Karai
INSERT INTO property_listings (id, title, price, location, bedrooms, bathrooms, area, property_type, transaction_type) VALUES
(2, '5 Bedroom Property', 'KSh 22,000,000', '5 Bed House with En Suite at Karai', 4, 4, 'N/A', 'House', 'Sale');

-- Property 3: 4 Bedroom Villa in Loresho Ridge
INSERT INTO property_listings (id, title, price, location, bedrooms, bathrooms, area, property_type, transaction_type) VALUES
(3, '4 Bedroom Property', 'KSh 135,000,000', '4 Bed Villa with En Suite at Loresho Ridge', 4, 5, 'N/A', 'Villa', 'Sale');

-- Property 4: 2 Bedroom House for Rent in Karen
INSERT INTO property_listings (id, title, price, location, bedrooms, bathrooms, area, property_type, transaction_type) VALUES
(4, '2 Bedroom Property', 'KSh 140,000 / month', '2 Bed House with En Suite at Karen ', 2, 2, 'N/A', 'House', 'Rent');

-- Property 6: 4 Bedroom House in Ruiru-Kiambu Road
INSERT INTO property_listings (id, title, price, location, bedrooms, bathrooms, area, property_type, transaction_type) VALUES
(6, '4 Bedroom Property', 'KSh 32,450,000', '4 Bed House with En Suite at Ruiru-Kiambu Road', 5, 5, 'N/A', 'House', 'Sale');

-- Property 9: 5 Bedroom Townhouse in Lavington
INSERT INTO property_listings (id, title, price, location, bedrooms, bathrooms, area, property_type, transaction_type) VALUES
(9, '5 Bedroom Property', 'KSh 81,000,000', '5 Bed Townhouse with En Suite in Lavington ', 4, 6, 'N/A', 'Townhouse', 'Sale');

-- Property 10: 4 Bedroom Townhouse in Lavington
INSERT INTO property_listings (id, title, price, location, bedrooms, bathrooms, area, property_type, transaction_type) VALUES
(10, '4 Bedroom Property', 'KSh 72,000,000', '4 Bed Townhouse with En Suite in Lavington ', 4, 5, 'N/A', 'Townhouse', 'Sale');
...
(4, 'id4_Images/9dc9c235-e37f-4110-ae08-3689ddeca4d1.jpeg', 9),
...
SELECT 'Property Tables Updated Successfully' as status;
SELECT 'Properties for Sale:' as info, count(*) as count FROM property_listings WHERE transaction_type = 'Sale';
SELECT 'Properties for Rent:' as info, count(*) as count FROM property_listings WHERE transaction_type = 'Rent';
SELECT 'Total Properties:' as info, count(*) as count FROM property_listings;
SELECT 'Total Images:' as info, count(*) as count FROM property_images;
